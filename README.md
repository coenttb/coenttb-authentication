...
`coenttb-authentication` is a library for authentication and authorization, using `swift-authentication`.  
...
You can add `coenttb-authentication` to an Xcode project by including it as a package dependency:

Repository URL: https://github.com/coenttb/coenttb-authentication
